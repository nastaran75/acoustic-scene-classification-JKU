...
spec_proc = LogarithmicFilteredSpectrogramProcessor(filterbank=LogFilterbank, num_bands=24, fmin=20, fmax=16000,norm_filters=True)
...
np.save('spec_madmom_2016_' + sys.argv[1][:-4] + '_images.npy',images)
np.save('spec_madmom_2016_' + sys.argv[1][:-4] + '_labels.npy', labels)
