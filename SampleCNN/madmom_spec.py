...
spec_proc = LogarithmicFilteredSpectrogramProcessor(filterbank=LogFilterbank, num_bands=int(args.bins), fmin=20, fmax=16000,norm_filters=True)
...
np.save('2017_' + sys.argv[1][:-4] + '_images.npy',images)
np.save('2017_' + sys.argv[1][:-4] + '_labels.npy', labels)
